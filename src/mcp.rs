//! MCP application state and auth policy.
//!
//! This module wires together the service layer and auth policy into `AppState`,
//! which is passed to every MCP request handler.
...
pub use rmcp_server::{
    rmcp_server, streamable_http_config, streamable_http_service, ExampleRmcpServer,
};
