...
| `generate-docs.py` | Python | `cargo xtask generate-docs`, `cargo xtask check-docs`, CI | Generates/checks volatile docs and metadata from the contract-owned `ACTION_SPECS`, `ENV_KEY_SPECS`, and typed config defaults. |
