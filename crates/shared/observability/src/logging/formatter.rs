...
// ── Raw ANSI helpers ──────────────────────────────────────────────────────────
//
// CUSTOMIZE: We use raw ANSI codes rather than the `console` crate because:
...
///
/// # CUSTOMIZE: Adding custom field types
///
...
///
/// # CUSTOMIZE: Injection attack example
///
...
///
/// # CUSTOMIZE: Semantic coloring rules
///
...
///
/// # CUSTOMIZE: Adding field colors for your service
///
...
/// use soma_observability::logging::formatter::AuroraFormatter;
///
/// fmt::layer()
...
///
/// ```text
/// 14:32:01  INFO  starting  bind=0.0.0.0:3000  auth=bearer  service=soma-mcp
/// ────────  ────  ─────────  ─────────────────────────────────────────────────
    ...
    N: for<'a> FormatFields<'a> + 'static,
{
    fn format_event(
        ...
        //
        // CUSTOMIZE: We use local HH:MM:SS rather than UTC ISO 8601 because:
        ...
        //
        // CUSTOMIZE: Message token coloring convention:
        //
        ...
        //
        // CUSTOMIZE: Priority field order
        //
