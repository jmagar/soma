...
/// # Arguments
///
/// - `data_dir` — service data directory (e.g. `~/.soma`). Logs go into
...
pub fn init(data_dir: &Path, service_name: &str) -> Result<()> {
    ...
    tracing_subscriber::registry()
        ...
        .with(
            ...
            //
            // CUSTOMIZE: Console layer configuration
        ...
        .with(
            ...
            //
            // CUSTOMIZE: File layer configuration
...
///
/// # CUSTOMIZE: Truncation vs rotation
///
