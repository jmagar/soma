...
**Proposed path:** `crates/shared/knowledge/memory`  
**Delivery phase:** Knowledge intelligence  
**Publication:** Publishable after RAG contracts stabilize.

## Purpose

Evidence-backed durable memory lifecycle and recall engine.
...
- Agent orchestration
- Embedding/vector implementations
- Graph store implementation
- Soma personal-memory policy
...
- soma-primitives
- soma-rag traits or narrow retrieval port
- soma-llm optional
- sqlx optional
